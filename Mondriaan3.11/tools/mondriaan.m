function [I, s, p, q, r, c, rh, ch, B, u, v] = mondriaan(A, NumProcessors, Imbalance, Permutation, Symmetry)
...
if (nargout < 9)
    ...
    [I, s, p, q, r, c, rh, ch] = MatlabMondriaan(Pass, NumProcessors, Imbalance, -1, Permutation, Symmetry>0);
else
    if (nargout < 10)
        [I, s, p, q, r, c, rh, ch, B] = MatlabMondriaan(Pass, NumProcessors, Imbalance, -1, Permutation, Symmetry>0);
    else
        [I, s, p, q, r, c, rh, ch, B, u, v] = MatlabMondriaan(Pass, NumProcessors, Imbalance, -1, Permutation, Symmetry>0);
    end
    if (Symmetry == 2)
        B=A(p,q);
    end

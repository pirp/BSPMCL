function mondriaanplot(A, NumProcessors, Imbalance, Permutation, Symmetry, Iterations)
...
%
%         Usage:
%             mondriaanplot(A, NumProcessors, Imbalance, Permutation, Symmetry, Iterations);
%
if (nargin < 3)
...
[I, s, p, q, r, c, rh, ch, B, u, v] = MatlabMondriaan(Pass, NumProcessors, Imbalance, Iterations, Permutation, Symmetry>0);

...
struct opts {
    ...
    enum {Alternate, LocalBest, Hybrid, LocalRatio,
          OneDimRow, OneDimCol, FineGrain, SFineGrain} SplitStrategy;
    ...
    enum {MetricLambda, MetricCut} Metric;
    ...
    enum {OneFile, MultipleFiles} OutputMode; /* Extended or (original) distributed MatrixMarket */
    ...
    enum {MatchRandom, MatchInprod} Coarsening_MatchingStrategy;
